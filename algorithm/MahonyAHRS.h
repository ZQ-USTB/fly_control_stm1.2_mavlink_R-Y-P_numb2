...
extern void AHRS_init(float quat[4], float accel[3], float mag[3]);
extern void get_angle(float q[4], float *yaw, float *pitch, float *roll);
extern void AHRS_update(float quat[4], float time, float gyro[3], float accel[3], float mag[3]);
#endif
//=====================================================================================================
// End of file
//=====================================================================================================
